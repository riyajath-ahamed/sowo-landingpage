...
const features = [
 ...
 const Cta = () => {
    return (
      <div id="values" className="overflow-hidden bg-transparent py-24 sm:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              At SOWO, our core values drive every action we take and every decision we make. We are committed to:
              </p>
